...
enemy = pygame.image.load(
    "C:/Users/young/Desktop/pythonworkspace_util/pygame.basic/enemy.png")
...
# 폰트 정의
game_font = pygame.font.Font(None, 40)  # 폰트 객체 생선 (폰트, 크기)
...
# 20 fps : 1초 동안에 20번 동작 -> 1번에 5만큼 이동. 5 * 20 = 100
    ...
    character_rect = character.get_rect()  # 좌표, width height 포함중
    character_rect.left = character_x_pos  # 화면 상의 character 정보를 표시
    ...
    # 충돌 체크
    if character_rect.colliderect(enemy_rect):  # 만일 충돌 했다면
        print("충돌했어요")
        running = False
    ...
    timer = game_font.render(str(int(total_time - elapsed_time)),
                             True, (255, 255, 255))  # 출력할 글자, 그냥 True, 글자 색상
