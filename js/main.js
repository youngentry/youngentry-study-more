window.addEventListener("DOMContentLoaded", () => {
    ...
    document
        .querySelector(".top_search strong")
        .addEventListener("click", function () {
            this.classList.toggle("on");
    ...
    document
        .querySelector(".MainVisual .slide_handler .next")
        .addEventListener("click", () => {
            MAINSLIDE.slideNext();
        });
    document
        .querySelector(".MainVisual .slide_handler .prev")
        .addEventListener("click", () => {
            MAINSLIDE.slidePrev();
        });
    ...
    document
        .querySelector(".Portfolio .slide_handler .next")
        .addEventListener("click", () => {
            PRS.slideNext();
        });
    document
        .querySelector(".Portfolio .slide_handler .prev")
        .addEventListener("click", () => {
            PRS.slidePrev();
        });
    ...
    const SCS = new Swiper(".Solution .center_slider", {
        ...
        on: {
            slideChangeTransitionEnd: function () {
                ...
                document.querySelector(".solution_slider_num").innerHTML =
                    "0" + (this.realIndex + 1) + "<span>  / 0" + SCBOX.length;
            },
        },
    });

    document
        .querySelector(".Solution .slide_handler .next")
        .addEventListener("click", () => {
            SCS.slideNext();
        });
    document
        .querySelector(".Solution .slide_handler .prev")
        .addEventListener("click", () => {
            SCS.slidePrev();
        });
