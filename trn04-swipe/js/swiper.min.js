        ...
        for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
          ...
          if (null != s)
            for (var r = Object.keys(Object(s)), n = 0, o = r.length; n < o; n += 1) {
              ...
              void 0 !== d &&
                d.enumerable &&
                (te.isObject(a[l]) && te.isObject(s[l]) ? te.extend(a[l], s[l]) : !te.isObject(a[l]) && te.isObject(s[l]) ? ((a[l] = {}), te.extend(a[l], s[l])) : (a[l] = s[l]));
            }
        }
        return a;
      },
      ...
      events: {
        attachEvents: function () {
                    ...
                    if (!(t.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(c, 2)) < t.params.threshold)) {
                      ...
                      if (void 0 === a.isScrolling)
                        (t.isHorizontal() && s.currentY === s.startY) || (t.isVertical() && s.currentX === s.startX)
                          ? (a.isScrolling = !1)
                          : 25 <= p * p + c * c && ((u = (180 * Math.atan2(Math.abs(c), Math.abs(p))) / Math.PI), (a.isScrolling = t.isHorizontal() ? u > i.touchAngle : 90 - u > i.touchAngle));
                      if ((a.isScrolling && t.emit("touchMoveOpposite", n), void 0 === a.startMoving && ((s.currentX === s.startX && s.currentY === s.startY) || (a.startMoving = !0)), a.isScrolling))
                        a.isTouched = !1;
                        ...
                        if (
                          ...
                          0 < h && a.currentTranslate > t.minTranslate()
                            ...
                            : h < 0 &&
                              ...
                              ((v = !1), i.resistance && (a.currentTranslate = t.maxTranslate() + 1 - Math.pow(t.maxTranslate() - a.startTranslate - h, f))),
          ...
          if (ae.touch || (!ae.pointerEvents && !ae.prefixedPointerEvents)) {
            ...
            ((t.simulateTouch && !g.ios && !g.android) || (t.simulateTouch && !ae.touch && g.ios)) &&
              (r.addEventListener("mousedown", e.onTouchStart, !1), m.addEventListener("mousemove", e.onTouchMove, n), m.addEventListener("mouseup", e.onTouchEnd, !1));
        ...
        detachEvents: function () {
          ...
          if (ae.touch || (!ae.pointerEvents && !ae.prefixedPointerEvents)) {
            ...
            ((t.simulateTouch && !g.ios && !g.android) || (t.simulateTouch && !ae.touch && g.ios)) &&
              (r.removeEventListener("mousedown", e.onTouchStart, !1), m.removeEventListener("mousemove", e.onTouchMove, n), m.removeEventListener("mouseup", e.onTouchEnd, !1));
        ...
        if (e.params.history) {
          ...
          (t.initialized = !0),
            ...
            (t.paths.key || t.paths.value) &&
              (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || ee.addEventListener("popstate", e.history.setHistoryPopState));
        }
      },
      destroy: function () {
    ...
    _ = {
      ...
      setTransition: function (e) {
        var a = this,
          ...
          s = a.$wrapperEl;
        if (
          (t.transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), a.params.virtualTranslate && 0 !== e)
        ) {
          var r = !1;
      ...
      init: function () {
        ...
        t.swiper instanceof a
          ...
          : te.isObject(t.swiper) &&
            ((e.thumbs.swiper = new a(te.extend({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
    ...
    J = [
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          te.extend(e, {
            history: { init: q.init.bind(e), setHistory: q.setHistory.bind(e), setHistoryPopState: q.setHistoryPopState.bind(e), scrollToSlide: q.scrollToSlide.bind(e), destroy: q.destroy.bind(e) },
          });
        },
        on: {
          init: function () {
